...
"\u82b1\u84ee\u5e02":2306187,"\u842c\u91cc":2306231,"\u8607\u6fb3":2306208,"\u864e\u5c3e":2306250,"\u897f\u5c6f":2306181,"\u89c0\u97f3":2306200,"\u91d1\u5c71":2306223,"\u95dc\u5c71":2306227,"\u96d9\u6eaa":2306251,"\u9ad8\u96c4\u6a5f\u5834":2306255,"\u9daf\u6b4c":2306214,"\u9e7f\u6e2f":2306201,"\u9ebb\u8c46":2306203,"\u9f8d\u6f6d":2306202},cityInit=function(){var a=[],c;
for(c in cityToWoeid)a.push('<div class="btn btn-link" id="'+cityToWoeid[c]+'">'+c+"</div>");
$("#method1").append(a);var a=[],d;for(d in city)a.push("<option>"+
city[d]+"</option>");
$("#citybox1").append(a);
$("#citybox1").trigger("change");
$(".selectpicker").selectpicker()},updateWeather=function(a){$.getJSON("http://query.yahooapis.com/v1/public/yql?format=json&q=select * from weather.forecast where woeid="+a,{},function(a,d){console.log("data",a);
...
$("#method1").on("click","div.btn.btn-link",function(a){console.log(a.target.id);
updateWeather(a.target.id)});
$("#citybox1").change(function(){var a=$(this).find(":selected").text(),c=[],d=cityToWoeid[scity[a][0]],b;for(b in scity[a])c.push("<option>"+scity[a][b]+"</option>");
$("#citybox2").children().remove();
$("#citybox2").append(c);updateWeather(d);
$(".selectpicker").selectpicker()});
$("#citybox2").change(function(){var a=$(this).find(":selected").text();
